...
public class AuthFilter implements GlobalFilter, Ordered {
            ...
            if(StringUtils.isNotEmpty(token)){
                ...
                if (userObject != null) {
                    ...
                    ServerHttpRequest mutableReq = request.mutate().header(CacheConstants.DETAILS_USER_ID, userId)
                            .header(CacheConstants.HEADER,token)
    ...
    private String getToken(ServerHttpRequest request) {
        ...
        if(StringUtils.isBlank(token)){
            ...
            if(queryParams != null && queryParams.containsKey(CacheConstants.HEADER)){
                token = queryParams.getFirst(CacheConstants.HEADER);
            }
        }
    ...
    private String getTenantKey(ServerHttpRequest request) {
        ...
        if(StringUtils.isBlank(tenantKey)){
            MultiValueMap<String, String> queryParams = request.getQueryParams();
            if(queryParams != null && queryParams.containsKey(CacheConstants.DETAILS_TENANT_KEY)){
                tenantKey = queryParams.getFirst(CacheConstants.DETAILS_TENANT_KEY);
            }
        }
        return tenantKey;
    }
