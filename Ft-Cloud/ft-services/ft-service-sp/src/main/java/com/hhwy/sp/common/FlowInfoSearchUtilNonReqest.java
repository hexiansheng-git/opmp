...
import com.hhwy.sp.common.mapper.FlowInfoMapper;
 ...
 */
@Log4j2
public class FlowInfoSearchUtilNonReqest {
    ...
    * 时间: 2024/3/18
    */
    public static <T extends CommonBaseEntity> List<T> getFlowInfo(List<T> list, FlowEnum flowEnum, String tenantKey, String loginUserName){
        if(StrUtil.isBlank(tenantKey) || CollectionUtils.isEmpty(list) || flowEnum == null || StringUtil.isBlank(flowEnum.getTableName()))
            return list;
    ...
    private static <T extends CommonBaseEntity> void setProcessInfo(List<T> list, FlowEnum flowEnum, List<CommonBaseEntity> flowList, String loginUserName, String tenantKey){
        //业务ID : 流程信息
        ...
        for (T t : list) {
            ...
            t.setIsFirstNode(isFirstNodeEdit(flowInfo.getInstanceId(), loginUserName));
        }
        //查询流程审批人名称
...
//    }
    ...
    private static String isFirstNodeEdit(String insId, String loginUserName){
        ...
        boolean isFirst= ObjectUtils.nvlString(result.get(AjaxResult.DATA_TAG)).equalsIgnoreCase(loginUserName);
        return isFirst?"1":"0";
    }
