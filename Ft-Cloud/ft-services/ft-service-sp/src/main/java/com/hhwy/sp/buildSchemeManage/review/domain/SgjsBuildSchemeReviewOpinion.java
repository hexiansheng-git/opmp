 ...
 * @remark sgjs_build_scheme_review_opinion
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SgjsBuildSchemeReviewOpinion extends BaseEntity {
     ...
     */
    @JsonProperty
    @Excel(name = "区域总工意见（1：通过  2：修改后通过  3：不通过）")
     ...
     */
    @JsonProperty
    @Excel(name = "海外事业部总工意见（1：通过  2：修改后通过  3：不通过）")
    private String overseasChiefOpinion;
    /**
     * 字段描述：海外事业部总工详细意见
     */
    @JsonProperty
    @Excel(name = "海外事业部总工详细意见")
