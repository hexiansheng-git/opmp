...
public class SgjsTechnicalFileBlueprint extends TreeNode<SgjsTechnicalFileBlueprint> {
    ...
    @JsonIgnore
    public Integer getBlueprintCount() {
        return blueprintCount;
    }

    @JsonIgnore
    public void setBlueprintCount(Integer blueprintCount) {
    ...
    @JsonIgnore
    public String getBlueprintValid() {
        return blueprintValid;
    }

    @JsonIgnore
    public void setBlueprintValid(String blueprintValid) {
        this.blueprintValid = blueprintValid;
    }

    @JsonIgnore
    public String getRecycleOr() {
        return recycleOr;
    }

    @JsonIgnore
    public void setRecycleOr(String recycleOr) {
        this.recycleOr = recycleOr;
    }

    @JsonIgnore
    public String getSignetValid() {
        return signetValid;
    }

    @JsonIgnore
    public void setSignetValid(String signetValid) {
        this.signetValid = signetValid;
    }
