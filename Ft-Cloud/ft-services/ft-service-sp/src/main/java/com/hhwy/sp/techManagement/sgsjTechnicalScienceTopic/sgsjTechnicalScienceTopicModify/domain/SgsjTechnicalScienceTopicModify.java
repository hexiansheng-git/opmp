...
public class SgsjTechnicalScienceTopicModify extends BaseEntity {
    ...
    @JsonIgnore
    public void setTopicNode(String topicNode) {
    ...
    @JsonIgnore
    public String getModifyPersionName() {
        return modifyPersionName;
    }

    @JsonIgnore
    public void setModifyPersionName(String modifyPersionName) {
        this.modifyPersionName = modifyPersionName;
    }
