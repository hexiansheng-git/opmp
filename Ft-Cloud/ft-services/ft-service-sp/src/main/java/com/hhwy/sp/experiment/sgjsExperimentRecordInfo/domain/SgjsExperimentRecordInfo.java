package com.hhwy.sp.experiment.sgjsExperimentRecordInfo.domain;
 ...
 * @remark   sgjs_experiment_record_info
 */
public class SgjsExperimentRecordInfo extends BaseEntity {
     ...
     */
    @JsonProperty
    @Excel(name = "来源"    ,dateFormat = "yyyy-MM-dd"  )
    ...
    @JsonFormat(pattern = "yyyy-MM-dd")
    @JsonProperty
    @Excel(name = "检验标定日期"    ,dateFormat = "yyyy-MM-dd"  )
    ...
    @JsonFormat(pattern = "yyyy-MM-dd")
    @JsonProperty
    @Excel(name = "下次检验标定日期"    ,dateFormat = "yyyy-MM-dd"  )
