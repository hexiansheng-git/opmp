 ...
 * @remark kcsj_group_manage_approach_staff
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class KcsjGroupManageApproachStaff extends BaseEntity {
    ...
    @JsonFormat(pattern = "yyyy-MM-dd")
    @JsonProperty
    @Excel(name = "离场时间", dateFormat = "yyyy-MM-dd")
