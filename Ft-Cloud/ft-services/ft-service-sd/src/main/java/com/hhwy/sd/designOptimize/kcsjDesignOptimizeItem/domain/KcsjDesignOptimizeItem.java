...
public class KcsjDesignOptimizeItem extends BaseEntity {
    ...
    @JsonIgnore
    public void setOptimizeId(Long optimizeId) {
    ...
    @JsonIgnore
    public BigDecimal getBeforeOptimizeQty() {
        return beforeOptimizeQty;
    }

    @JsonIgnore
    public void setBeforeOptimizeQty(BigDecimal beforeOptimizeQty) {
        this.beforeOptimizeQty = beforeOptimizeQty;
    }

    @JsonIgnore
    public BigDecimal getAfterOptimizeQty() {
        return afterOptimizeQty;
    }

    @JsonIgnore
    public void setAfterOptimizeQty(BigDecimal afterOptimizeQty) {
        this.afterOptimizeQty = afterOptimizeQty;
    }
