package com.hhwy.pm.qqch.preparation.quality.qqchSafetyTrain.domain;
...
@AllArgsConstructor
@NoArgsConstructor
public class QqchSafetyTrain extends CommonBaseEntity {
     ...
     */
    @JsonProperty
    @Excel(name = "对应1.5.2的ptvar2和8.3.3和7.6.1的")
    private String ptVar1;
    /**
     * 字段描述：预留字段2
     */
    @JsonProperty
    @Excel(name = "数据来源 1: 1.5.2;   2: 8.3.3;    3: 7.6.1;")
