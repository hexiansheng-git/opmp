...
/**
 * 跨国别设备调拨详情-拆卸吊装方案Mapper接口
 * 
 * @author hwj
 * @date 2022-12-20
 */
public interface SbchEquipmentAllotTransnationalDisassemblyMapper {
    /**
     * 查询跨国别设备调拨详情-拆卸吊装方案
     * 
    ...
    int batchInsert(List<SbchEquipmentAllotTransnationalDisassembly> dataList);
}
