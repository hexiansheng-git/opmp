 ...
 * @remark   qqch_tax_in
 */
public class QqchTaxIn extends BaseEntity {
    private static final long serialVersionUID = 1L;
        ...
        public void setDataType(String dataType) {
            ...
            @JsonIgnore
        public String getOtherBusName() {
            return otherBusName;
        }
        @JsonIgnore
        public void setOtherBusName(String otherBusName) {
            this.otherBusName = otherBusName;
        }
            @JsonIgnore
