 ...
 * @date 2022-11-17
 */
public interface WzchLocalPurchaseSupplyDetailMapper {
    /**
     * 查询采购供应策划材料视角物资详情
     *
     ...
     * @param entities
     */
    int insertOrUpdateBatch(@Param("entities") List<WzchLocalPurchaseSupplyDetailDTO> entities);
     ...
     * @return
     */
    int batchInsertOrUpdateBatchDetails(@Param("entities") List<WzchLocalPurchaseSupplyDetailDTO> entities);
     ...
     * @return
     */
    List<WzchLocalPurchaseSupplyDetailDTO> selectPurchaseSource(@Param("materialCodeList") List<String> materialCodeList);

    List<WzchLocalPurchaseSupplyDetailDTO> selectPurchaseView(@Param("list") List<Map<String, Object>> list);
