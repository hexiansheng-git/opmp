...
/**
 * 设备属地化  sbch_equipment_local_purchase
 * 
 * @author hwj
 * @date 2022-11-22
 */
@Data
@NoArgsConstructor
public class SbchEquipmentLocalPurchase extends MyPrepareBaseEntity {
    ...
    private List<SbchEquipmentLocalPurchaseDetails> detailsList;

    public SbchEquipmentLocalPurchase(Long id, Long projectId, String valid) {
        this.id = id;
        this.projectId = projectId;
        this.valid = valid;
    }

    public SbchEquipmentLocalPurchase(Long id, String valid) {
        this.id = id;
        this.projectId = projectId;
        this.valid = valid;
    }
