...
//    @PreAuthorize(hasPermi = "qqchTaxGlobal:list")
    @GetMapping("/list")
    @CustomLogger(title = "前期策划-前期策划编制-10财务策划-10.4整体资金计划", name = "10.4 整体资金计划" ,businessType = CustomBusinessType.SELECT)
...
//    @PreAuthorize(hasPermi = "qqchTaxGlobal:save")
    @PostMapping("/save")
    @CustomLogger(title = "前期策划-前期策划编制-10财务策划-10.4整体资金计划", name = "10.4 整体资金计划" ,businessType = CustomBusinessType.SAVE)
...
//    @PreAuthorize(hasPermi = "qqchTaxGlobal:remove")
    ...
    @CustomLogger(title = "前期策划-前期策划编制-10财务策划-10.4整体资金计划", name = "10.4 整体资金计划" ,businessType = CustomBusinessType.IMPORT)
