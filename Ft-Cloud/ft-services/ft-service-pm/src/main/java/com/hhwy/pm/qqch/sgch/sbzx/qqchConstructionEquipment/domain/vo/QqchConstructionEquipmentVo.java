package com.hhwy.pm.qqch.sgch.sbzx.qqchConstructionEquipment.domain.vo;
...
@Data
public class QqchConstructionEquipmentVo {
     ...
     * 字段描述：设计技术优化要点集合
     */
    private List<QqchConstructionEquipment> qqchConstructionEquipmentList;
}
