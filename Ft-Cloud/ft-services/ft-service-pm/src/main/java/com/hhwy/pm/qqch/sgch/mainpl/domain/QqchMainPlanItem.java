 ...
 * @remark qqch_main_plan_item
 */
@Data
public class QqchMainPlanItem extends TreeNode<QqchMainPlanItem> {
     ...
     * 里程碑类型
     */
    public final static String TYPE_MILESTONE = "milestone";

    /**
     * 里程碑类型
     */
    public final static String START_MILESTONE = "Start Milestone";

    /**
     * 里程碑类型
     */
    public final static String FINISH_MILESTONE = "Finish Milestone";


    /**
     * 表名
     */
    public final static String TABLE_NAME = "qqch_main_plan_item";
