...
/**
 * 清关档案策划对象 sbch_import_customs_clear
 * 
 * @author zq
 * @date 2022-12-14
 */
@Data
public class SbchImportCustomsClear extends MyPrepareBaseEntity {
...
//    @NotBlank(message = "标题不能为空",groups = {ValidationGroups.Save.class, ValidationGroups.Update.class})
    ...
    /** 是否有效（0，失效，1：有效） */
    @Excel(name = "是否有效", readConverterExp = "0=失效，1=有效")
...
//    @NotNull(message = "所属部门不能为空",groups = {ValidationGroups.Save.class, ValidationGroups.Update.class})
    ...
    private List<SbchImportCustomsClearDetail> detailList;
