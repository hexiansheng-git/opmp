 ...
 * @date 2022-12-14
 */
public interface ISbchImportCustomsClearService {
    /**
     * 查询清关档案策划
     * 
     * @param id 清关档案策划ID
    ...
    SbchImportCustomsClear getList(BigDecimal version);

    void batchSave(SbchImportCustomsClear sbchImportCustomsClear);
}
