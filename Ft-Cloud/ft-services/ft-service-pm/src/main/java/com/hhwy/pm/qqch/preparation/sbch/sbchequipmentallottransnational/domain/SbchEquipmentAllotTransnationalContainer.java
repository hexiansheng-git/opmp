...
/**
 * 跨国别设备调拨详情-集装箱运输方案对象 sbch_equipment_allot_transnational_container
 * 
 * @author hwj
 * @date 2022-12-22
 */
@Data
public class SbchEquipmentAllotTransnationalContainer extends CommonBaseEntity {
...
//    @NotNull(message = "设备重量不能为空",groups = {ValidationGroups.Update.class,ValidationGroups.Save.class})
    ...
    @JsonSerialize(using= ToStringSerializer.class)
    @NotNull(message = "20尺集装箱数量不能为空",groups = {ValidationGroups.Update.class, ValidationGroups.Save.class})
    private Long twentySizeNum;

    /** 40尺集装箱数量 */
    @Excel(name = "40尺集装箱数量")

    @JsonSerialize(using= ToStringSerializer.class)
    @NotNull(message = "40尺集装箱数量不能为空",groups = {ValidationGroups.Update.class, ValidationGroups.Save.class})
    private Long fortySizeNum;
    ...
    @NotNull(message = "运输时常不能为空",groups = {ValidationGroups.Update.class, ValidationGroups.Save.class})
