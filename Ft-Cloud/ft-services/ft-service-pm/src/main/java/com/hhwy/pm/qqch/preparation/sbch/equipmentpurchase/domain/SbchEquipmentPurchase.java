package com.hhwy.pm.qqch.preparation.sbch.equipmentpurchase.domain;
 ...
 */
@Data
public class SbchEquipmentPurchase extends MyPrepareBaseEntity {
...
//    @NotNull(message = "版本号",groups = {ValidationGroups.Update.class, ValidationGroups.Save.class})
    ...
    private List<SbchEquipmentPurchaseDetails> detailsList;
}
