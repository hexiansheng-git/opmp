package com.hhwy.pm.qqch.preparation.contractPlan.secondManagePlan.domain.vo;
 ...
 * @remark 普通要点策划/变更策划/索赔策划 类
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SecondManageKeyPointPlan {
    ...
    private List<SecondManageKeyPointPlan> children;
}
