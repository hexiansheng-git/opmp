package com.hhwy.pm.qqch.preparation.survey.surveyResultAsk.domain;
...
@Data
public class QqchSurveyResultAskVo {
    /**
     ...
     * 字段描述：完整设计交接情况集合
     */
    private List<QqchSurveyResultAsk> qqchSurveyResultAskList;
}
