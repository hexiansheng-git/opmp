...
/**
 * 跨国别设备调拨对象 sbch_equipment_allot_transnational
 *
 * @author hwj
 * @date 2022-12-20
 */
@Data
public class SbchEquipmentAllotTransnational extends MyPrepareBaseEntity {
    ...
    private List<SbchEquipmentAllotTransnationalDetails> detailsList = new ArrayList<>();
