 ...
 */
@Data
public class QyzsFinanceTaxItemRate extends BaseEntity {
    ...
    @JsonProperty
    @Excel(name = "税种描述")
    private String taxesCategoriesDescribe;
    /**
     * 字段描述：税率
     */
    @JsonProperty
    ...
    @JsonProperty
    @Excel(name = "纳税期限")
    private String taxPaymentDeadline;
    /**
     * 字段描述：申报程序
     */
    @JsonProperty
    ...
    @JsonProperty
    @Excel(name = "税收优惠政策")
    private String preferentialTaxPolicy;
    /**
     * 字段描述：操作流程描述
     */
    @JsonProperty
    @Excel(name = "操作流程描述")
    private String operationProcessDescription;
