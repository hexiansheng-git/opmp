package com.hhwy.pm.jdgl.monthpl.jdglMonthImagePlan.domain;
 ...
 * @remark jdgl_month_image_plan
 */
@Data
public class JdglMonthImagePlan extends TreeNode<JdglMonthImagePlan> {
