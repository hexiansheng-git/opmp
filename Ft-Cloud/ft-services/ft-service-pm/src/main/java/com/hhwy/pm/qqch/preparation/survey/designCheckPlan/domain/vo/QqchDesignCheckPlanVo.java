package com.hhwy.pm.qqch.preparation.survey.designCheckPlan.domain.vo;
...
@Data
public class QqchDesignCheckPlanVo {
    /**
     ...
     * 字段描述：完整设计交接情况集合
     */
    private List<QqchDesignCheckPlan> qqchDesignCheckPlanList;
}
