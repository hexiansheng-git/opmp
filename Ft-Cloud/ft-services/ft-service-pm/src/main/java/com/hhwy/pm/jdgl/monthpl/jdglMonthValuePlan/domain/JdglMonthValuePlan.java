package com.hhwy.pm.jdgl.monthpl.jdglMonthValuePlan.domain;
 ...
 * @remark jdgl_month_value_plan
 */
@Data
public class JdglMonthValuePlan extends TreeNode<JdglMonthValuePlan> {
    ...
    private BigDecimal monthPlanCompDesignQuantity;
    /**
     * 字段描述：本月计划产值（合同币种）
     */
    @JsonProperty
    @Excel(name = "本月计划产值（合同币种）")
    private BigDecimal monthPlanValueCu;
    /**
     * 字段描述：附件组id
     */
    @JsonProperty
