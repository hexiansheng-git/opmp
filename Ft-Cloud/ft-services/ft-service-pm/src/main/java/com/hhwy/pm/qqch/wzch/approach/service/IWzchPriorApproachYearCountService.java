...
/**
 * 优先进场物资详情年份数据Service接口
 * 
 * @author mls
 * @date 2022-11-30
 */
public interface IWzchPriorApproachYearCountService {
    /**
     * 查询优先进场物资详情年份数据
     * 
    ...
    /**
     * 批量插入
     * @param wzchPriorApproachYearCounts
     * @return
     */
    int batchInsert(List<WzchPriorApproachYearCount> wzchPriorApproachYearCounts);
