package com.hhwy.pm.qqch.preparation.survey.designDisclosurePlan.domain.vo;
...
@Data
public class QqchDesignDisclosurePlanVo {
    /**
     ...
     * 字段描述：完整设计交接情况集合
     */
    private List<QqchDesignDisclosurePlan> qqchDesignDisclosurePlanList;
}
