package com.hhwy.pm.qqch.sgch.sbzx.qqchMeasuringInstrument.domain.vo;
...
@Data
public class QqchMeasuringInstrumentVo {
     ...
     * 字段描述：设计技术优化要点集合
     */
    private List<QqchMeasuringInstrument> qqchMeasuringInstrumentList;
}
