...
public class QqchTaxInController extends BaseController{
    ...
    @PreAuthorize(hasPermi = "qqchTaxIn:list")
    @GetMapping("/list")
    public AjaxResult getQqchTaxInList(@Validated(ValidationGroups.Select.class) QqchTaxIn qqchTaxInParam){
        startPage();
        List<QqchTaxIn> qqchTaxInList = qqchTaxInService.getQqchTaxInList(qqchTaxInParam);
        return getDataTableAjaxResult(qqchTaxInList);
    }

    @PreAuthorize(hasPermi = "qqchTaxIn:add")
    @PostMapping("/add")
    public AjaxResult insertQqchTaxIn(@Validated(ValidationGroups.Save.class) @RequestBody QqchTaxIn qqchTaxInParam){
        qqchTaxInService.insertQqchTaxIn(qqchTaxInParam);
