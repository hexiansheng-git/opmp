package com.hhwy.pm.qqch.sgch.sbzx.qqchSmallMachinery.domain.vo;
...
@Data
public class QqchSmallMachineryVo {
     ...
     * 字段描述：设计技术优化要点集合
     */
    private List<QqchSmallMachinery> qqchSmallMachineryList;
}
