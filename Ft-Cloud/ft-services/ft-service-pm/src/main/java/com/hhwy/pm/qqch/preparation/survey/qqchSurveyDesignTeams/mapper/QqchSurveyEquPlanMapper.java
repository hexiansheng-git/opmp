 ...
 */
public interface QqchSurveyEquPlanMapper {
    ...
    int insertQqchSurveyEquPlanList(@Param("qqchSurveyEquPlanList") List<QqchSurveyEquPlan> qqchSurveyEquPlanList);

    int updateQqchSurveyEquPlan(QqchSurveyEquPlan qqchSurveyEquPlan);

    int updateQqchSurveyEquPlanList(@Param("qqchSurveyEquPlanList") List<QqchSurveyEquPlan> qqchSurveyEquPlanList);
    
    int deleteQqchSurveyEquPlan(QqchSurveyEquPlan qqchSurveyEquPlan);

    int deleteQqchSurveyEquPlanByPks(@Param("qqchSurveyEquPlanPkList") List<Long> qqchSurveyEquPlanPkList);
    }
