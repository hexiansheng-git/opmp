...
public class QqchDangerProcessControlPlanServiceImpl implements IQqchDangerProcessControlPlanService {
    ...
    public QqchDangerProcessControlPlanVo getQqchDangerProcessControlPlanList(BigDecimal version) {
        ...
        List<QqchDangerProcessControlPlan> list = qqchDangerProcessControlPlanMapper
     ...
     */
    @Transactional
    public void updateQqchDangerProcessControlPlanList(QqchDangerProcessControlPlanVo voParam) {
        for (QqchDangerProcessControlPlan qqchDangerProcessControlPlan : voParam.getList()) {
            qqchDangerProcessControlPlan.setUpdateUser(SecurityUtils.getUserName());
            qqchDangerProcessControlPlan.setUpdateTime(DateUtils.getNowDate());
        }
        qqchDangerProcessControlPlanMapper.updateQqchDangerProcessControlPlanList(voParam.getList());
                ...
                if (!CollectionUtils.isEmpty(dbList)) {
                    for (QqchDangerProcessControlPlan db : dbList) {
                        if (db.getSchemeCode().equals(qqchDangerProcessControlPlan.getSchemeCode())) {
                            ...
                            qqchDangerProcessControlPlan.setFirstConfirmTime(db.getFirstConfirmTime());
                        }
                    }
                }
            }
