package com.hhwy.pm.jdgl.quarterpl.jdglQuarterImagePlan.domain;
 ...
 * @remark jdgl_quarter_image_plan
 */
@Data
public class JdglQuarterImagePlan extends TreeNode<JdglQuarterImagePlan> {
