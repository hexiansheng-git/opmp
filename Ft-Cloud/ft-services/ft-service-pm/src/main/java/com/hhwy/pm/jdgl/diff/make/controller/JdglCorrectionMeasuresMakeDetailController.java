...
public class JdglCorrectionMeasuresMakeDetailController extends BaseController {
    ...
    /***
     * 功能描述: 设置会签时责任人是否审批标识，用于标识会签时哪些责任人已审批
     * 作者: fushudong
     * 时间: 2023/12/27
     */
    @GetMapping("/setEidtFlag")
    public AjaxResult setEidtFlag() {
        return toAjax(jdglCorrectionMeasuresMakeDetailService.setEidtFlag());
    }
}
