...
public class QqchWorkPlanningPrjImgServiceImpl implements IQqchWorkPlanningPrjImgService {
    ...
    @Override
    public QqchWorkPlanningPrjImg getLatestQqchWorkPlanningPrjImg() {
        BigDecimal version = VersionUtil.getVersion("qqch_work_planning_prj_img", null);
        QqchWorkPlanningPrjImg query = new QqchWorkPlanningPrjImg();
        query.setVersion(version);
        QqchWorkPlanningPrjImg qqchWorkPlanningPrjImg = qqchWorkPlanningPrjImgMapper.getQqchWorkPlanningPrjImg(query);
        if(ObjectNullUtil.isEmpty(qqchWorkPlanningPrjImg)){
            qqchWorkPlanningPrjImg = new QqchWorkPlanningPrjImg();
        }
        return qqchWorkPlanningPrjImg;
    }
