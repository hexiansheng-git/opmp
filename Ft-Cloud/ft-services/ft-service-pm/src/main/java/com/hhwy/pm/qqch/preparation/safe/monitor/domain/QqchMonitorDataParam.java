package com.hhwy.pm.qqch.preparation.safe.monitor.domain;
 ...
 * @remark qqch_monitor_data_param
 */
@Data
public class QqchMonitorDataParam extends TreeNode<QqchMonitorDataParam> {
