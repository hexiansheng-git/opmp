 ...
 * @remark qqch_tax_installment
 */
public class QqchTaxInstallment extends CompileEntity<QqchTaxInstallment> {
    ...
    private Long id;
    /**
     * 字段描述：对应qqch_tax_stage的record_id
     */
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonProperty
    @Excel(name = "对应qqch_tax_stage的record_id")
    private Long inRecordId;
    /**
     * 字段描述：对应qqch_tax_cost的record_id
     */
    @JsonSerialize(using = ToStringSerializer.class)
    @JsonProperty
    @Excel(name = "对应qqch_tax_cost的record_id")
