...
//            return;
//        }
        if(CollectionUtils.isNotEmpty(paramJobList) && qqchConstJob instanceof QqchConstJob)
            this.qqchConstJobMapper.insertQqchConstJobList(paramJobList);
...
//            this.qqchConstJobMapper.insertQqchConstJobList(insertDataList);
//
//        // 前端和后台都有的数据 更新
