...
@Data
@ToString
public class WzchLocalPurchaseSupply extends MyPrepareBaseEntity {
    private static final long serialVersionUID = 1L;

    public WzchLocalPurchaseSupply() {
    }
    public WzchLocalPurchaseSupply(BigDecimal version) {
...
//        WzchLocalPurchaseSupplyDetail wzchPurchaseSupply = new WzchLocalPurchaseSupplyDetail();
//        String s = JsonUtils.toJsonStr(wzchPurchaseSupply);
