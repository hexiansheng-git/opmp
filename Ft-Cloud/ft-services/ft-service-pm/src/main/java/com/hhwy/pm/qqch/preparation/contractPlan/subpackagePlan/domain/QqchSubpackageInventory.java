package com.hhwy.pm.qqch.preparation.contractPlan.subpackagePlan.domain;
 ...
 * @remark qqch_subpackage_inventory
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class QqchSubpackageInventory extends BaseEntity {
     ...
     */
    @JsonProperty
    private String upMasterContractInventoryCode;
    /**
     * 字段描述：层级
     */
    @JsonProperty
