...
@Data
@NoArgsConstructor
public class SbchEquipmentLease extends MyPrepareBaseEntity {
    ...
    private String[] ids;
    public SbchEquipmentLease(Long id, Long projectId, String valid) {
        this.id = id;
        this.projectId = projectId;
        this.valid = valid;
    }

    public SbchEquipmentLease(Long id, String valid) {
        this.id = id;
        this.projectId = projectId;
        this.valid = valid;
    }
