...
@ToString
@Data
public class WzchPurchaseSupplyDetailDTO extends WzchPurchaseSupplyDetail {
    private static final long serialVersionUID = 1L;

    private String planPurchaseDateGroup;

    public WzchPurchaseSupplyDetailDTO() {
    }
    public WzchPurchaseSupplyDetailDTO(BigDecimal version) {
     ...
     * 批次信息
     */
    private List<WzchPurchaseSupplyDetailDTO> children;
