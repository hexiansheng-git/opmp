...
/**
 * 设备人员配置策划--特种设备人员详情对象 sbch_staffing_special_detail
 * 
 * @author zq
 * @date 2022-11-30
 */
@Data
public class SbchStaffingSpecialDetail extends CommonBaseEntity {
...
//    @NotNull(message = "总需计划子表id不能为空", groups = {ValidationGroups.Save.class, ValidationGroups.Update.class})
    ...
    /** 资格证书要求 */
    @Excel(name = "资格证书要求")
    @NotBlank(message = "资格证书要求不能为空",groups = {ValidationGroups.Save.class, ValidationGroups.Update.class})
    private String credentials;

    /** 人员来源 */
    @Excel(name = "人员来源")
    @NotBlank(message = "人员来源不能为空",groups = {ValidationGroups.Save.class, ValidationGroups.Update.class})
    ...
    /** 资格证书延期方案 */
    private String qualiDelateGroupId;

    /** 培训计划 */
    private String trainPlanGroupId;

    /** 培训考核方案 */
    private String trainCheckGroupId;
