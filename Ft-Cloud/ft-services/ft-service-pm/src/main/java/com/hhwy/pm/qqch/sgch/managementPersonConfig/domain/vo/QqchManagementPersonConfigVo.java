package com.hhwy.pm.qqch.sgch.managementPersonConfig.domain.vo;
...
@AllArgsConstructor
@NoArgsConstructor
public class QqchManagementPersonConfigVo {
    /**
     ...
     * 字段描述：管理人员配置
     */
    private List<QqchManagementPersonConfig> qqchManagementPersonConfigList;
}
