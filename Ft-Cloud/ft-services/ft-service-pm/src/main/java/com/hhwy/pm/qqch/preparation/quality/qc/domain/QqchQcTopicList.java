 ...
 * @remark qqch_qc_topic_list
 */
@Data
public class QqchQcTopicList extends BaseEntity {
     ...
     */
    @JsonProperty
    @Excel(name = "业务领域及产品名称")
    private String businessAreaName;
    /**
     * 字段描述：专业类别（字典类型professional_category）
     */
    @JsonProperty
    @Excel(name = "专业类别（字典类型professional_category）")
    ...
    private List<QqchQcTopicList> children;
}
