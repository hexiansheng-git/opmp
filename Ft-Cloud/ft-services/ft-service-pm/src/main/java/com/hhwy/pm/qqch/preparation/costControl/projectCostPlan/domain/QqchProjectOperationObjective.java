package com.hhwy.pm.qqch.preparation.costControl.projectCostPlan.domain;
...
@NoArgsConstructor
@AllArgsConstructor
public class QqchProjectOperationObjective extends BaseEntity {
    ...
    @JsonProperty
    @Excel(name = "经营目标")
    private String operationObjective;
    /**
     * 字段描述：主要事项
     */
    @JsonProperty
