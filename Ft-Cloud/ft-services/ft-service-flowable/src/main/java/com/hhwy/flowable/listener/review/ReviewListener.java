package com.hhwy.flowable.listener.review;
 ...
 * 前期策划工作小组审批流程监听器
 */
public class ReviewListener extends BaseExecutionListener {
    @Override
    public void notify(DelegateExecution delegateExecution) {
        ...
        AjaxResult result = bean.reviewListener(Long.valueOf(businessKey));
