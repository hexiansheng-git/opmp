 ...
 * 前期策划工作小组审批流程监听器
 */
public class SchemeReviewApprovedAfterModificationListener implements TaskListener, ExecutionListener {
    @Override
    public void notify(DelegateExecution delegateExecution) {
        ...
        AjaxResult result = bean.schemeReviewApprovedAfterModification(Long.valueOf(businessKey));
